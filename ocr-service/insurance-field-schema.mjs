export const POLICY_FIELD_SCHEMA = {
  ...
  name: {
    label: '产品名称',
    type: 'text',
    aliases: ['产品名称', '险种名称', '保险名称', '合同名称', '主险名称', '主合同名称', '保险险种', '产品计划', '保险产品名称', '险种计划', '险种/名称'],
  },
  applicant: {
    label: '投保人',
    type: 'person',
  ...
  coveragePeriod: {
    label: '保险期间',
    type: 'duration',
    aliases: ['保险期间', '保障期间', '保险期限', '保障期限', '保险责任期间', '合同期限'],
  },
  amount: {
    label: '基本保险金额',
    type: 'money',
  ...
  firstPremium: {
    label: '首期保险费',
    type: 'money',
    aliases: ['首期保险费', '首期保费', '首期保险费合计', '首年保费', '标准保险费', '保险费', '年交保费', '首期应交保险费', '首期应交保费', '首次保费', '首次保险费', '首年应交保费', '首年应交保险费', '总保费', '总保费(人民币)', '总保险费'],
  },
  beneficiary: {
    label: '身故受益人',
    type: 'text',
