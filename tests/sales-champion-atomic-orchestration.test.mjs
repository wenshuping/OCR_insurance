...
import { validateSalesTurnProposal } from '../server/sales-champion-turn.contract.mjs';
import {
...
import { evaluateSalesChampionShadowRoute } from '../server/sales-champion-shadow-router.service.mjs';
import { getSalesChampionTrainingPacks } from '../server/sales-champion-training-catalog.mjs';

function validProposal(overrides = {}) {
  return {
    contractVersion: 1,
    customerStatements: [{ text: '钱放二十年太久', source: 'current_message' }],
