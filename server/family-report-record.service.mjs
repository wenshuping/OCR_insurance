...
// Bump whenever the deterministic cashflow contract changes so existing
// persisted reports are rebuilt from the current policy cashflow rows.
export const FAMILY_REPORT_ENGINE_VERSION = 5;
