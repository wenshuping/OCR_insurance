...
export function buildStructuredResponsibilityPrompt({
  ...
  return [
    ...
    '- 每个 contentBlocks 元素必须包含 blockKey、title、enabled、editable、order、content；order 从 1 开始。',
    '- contentBlocks.productFunctions 只有在输入中的同版本官方证据明确支持账户、领取、分红等功能时才启用；无证据时必须关闭，不能根据产品名猜测。',
